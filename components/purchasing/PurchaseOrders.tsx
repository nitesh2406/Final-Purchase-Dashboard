                            ...
                            <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-[200] flex items-center justify-center p-4">
                                <Card className="max-w-md w-full bg-[#1e293b] border-slate-700 shadow-2xl p-8 text-center animate-in zoom-in-95 duration-200">
                                    ...
                                    <div className="flex gap-3">
                                        <Button 
                                            variant="secondary" 
                                            className="flex-1 border-slate-700 text-slate-300 h-11" 
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    ...
                    <Button 
                        ...
                        disabled={loading}
                        variant="secondary"
                        className="h-[42px] px-4 border-slate-700 flex items-center gap-2"
                        icon={loading ? <ArrowPathIcon className="w-4 h-4 animate-spin"/> : undefined}
                    >
                        {loading ? 'Syncing...' : '🔄 Sync Purchase Orders'}
                    </Button>
                    <Button variant="secondary" className="h-[42px] px-4 border-slate-700 flex items-center gap-2" icon={<FunnelIcon className="w-4 h-4"/>}>
                        Filters
                    </Button>
                </div>
            </div>
